...
{
    /// <summary>
    /// A STMP3410/3500/3600 ROM device.
    /// </summary>
    public class RecoveryDevice : Device, IRecoverable//, IComparable
    {
        internal RecoveryDevice(/*DeviceClass deviceClass,*/ IntPtr deviceInstance, string path/*, int index*/)
        ...
        public override bool Match(ushort? vid, ushort? pid)
        {
            ...
            {
                return (base.Match(0x066f, 0x3600) || base.Match(0x066f, 0x3500));
            }
            else
            {
