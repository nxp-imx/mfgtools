...
{
    public class MxSdpCmd : ScsiApi
    {
        /// <summary>
        /// SDP Command Set. 
        /// Byte[0-1] of the CDB for MX ROM-specific SDP commands.
        /// </summary>
        public enum CommandSet : short
        {
            ReadRegister  = 0x0101,
        ...
        protected MxSdpCmd(MxSdpCmd.CommandSet cmd, Api.CommandDirection dir, Int64 length, UInt32 tag, Int64 lparam)
