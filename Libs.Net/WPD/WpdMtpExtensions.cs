...
{
    public class MtpExtensions
    {
        // from WpdMtpExtensions.h

        static MtpExtensions()
        {
            ...
            ****************************************************************************/
            ...
            WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS = new Guid(0x4d545058, 0x1a2e, 0x4106, 0xa3, 0x57, 0x77, 0x1e, 0x8, 0x19, 0xfc, 0x56);
            ...
            WPD_COMMAND_MTP_EXT_GET_SUPPORTED_VENDOR_OPCODES .fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_COMMAND_MTP_EXT_EXECUTE_COMMAND_WITHOUT_DATA_PHASE .fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_COMMAND_MTP_EXT_EXECUTE_COMMAND_WITH_DATA_TO_READ .fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_COMMAND_MTP_EXT_EXECUTE_COMMAND_WITH_DATA_TO_WRITE.fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_COMMAND_MTP_EXT_READ_DATA .fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_COMMAND_MTP_EXT_WRITE_DATA.fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_COMMAND_MTP_EXT_END_DATA_TRANSFER  .fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_COMMAND_MTP_EXT_GET_VENDOR_EXTENSION_DESCRIPTION .fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_PROPERTY_MTP_EXT_OPERATION_CODE.fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_PROPERTY_MTP_EXT_OPERATION_PARAMS.fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_PROPERTY_MTP_EXT_RESPONSE_CODE.fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_PROPERTY_MTP_EXT_RESPONSE_PARAMS.fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_PROPERTY_MTP_EXT_VENDOR_OPERATION_CODES.fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_PROPERTY_MTP_EXT_TRANSFER_CONTEXT.fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_PROPERTY_MTP_EXT_TRANSFER_TOTAL_DATA_SIZE.fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_PROPERTY_MTP_EXT_TRANSFER_NUM_BYTES_TO_READ.fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_PROPERTY_MTP_EXT_TRANSFER_NUM_BYTES_READ.fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_PROPERTY_MTP_EXT_TRANSFER_NUM_BYTES_TO_WRITE.fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_PROPERTY_MTP_EXT_TRANSFER_NUM_BYTES_WRITTEN.fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_PROPERTY_MTP_EXT_TRANSFER_DATA.fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            WPD_PROPERTY_MTP_EXT_TRANSFER_DATA.pid = 1012;

            // [ VT_UI4 ] : Returns the optimal size of the transfer buffer
            WPD_PROPERTY_MTP_EXT_OPTIMAL_TRANSFER_BUFFER_SIZE.fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            WPD_PROPERTY_MTP_EXT_OPTIMAL_TRANSFER_BUFFER_SIZE.pid = 1013;

            // [ VT_LPWSTR ] : Returns vendor extension description string
            WPD_PROPERTY_MTP_EXT_VENDOR_EXTENSION_DESCRIPTION.fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            WPD_PROPERTY_MTP_EXT_EVENT_PARAMS.fmtid = WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
            ...
            ****************************************************************************/
            ...
            WPD_PROPERTIES_MTP_VENDOR_EXTENDED_OBJECT_PROPS = new Guid(0x4d545058, 0x4fce, 0x4578, 0x95, 0xc8, 0x86, 0x98, 0xa9, 0xbc, 0xf, 0x49);
            ...
            ****************************************************************************/
            ...
            WPD_PROPERTIES_MTP_VENDOR_EXTENDED_DEVICE_PROPS = new Guid(0x4d545058, 0x8900, 0x40b3, 0x8f, 0x1d, 0xdc, 0x24, 0x6e, 0x1e, 0x83, 0x70);
            ...
            ****************************************************************************/
            ...
            WPD_EVENT_MTP_VENDOR_EXTENDED_EVENTS = new Guid(0x00000000, 0x5738, 0x4ff2, 0x84, 0x45, 0xbe, 0x31, 0x26, 0x69, 0x10, 0x59);
            ...
            ****************************************************************************/
            ...
            // DEFINE_PROPERTYKEY(WPD_PROPERTY_MTP_EXT_EVENT_PARAMS, 0x4d545058, 0xef88, 0x4e4d, 0x95, 0xc3, 0x4f, 0x32, 0x7f, 0x72, 0x8a, 0x96, 1011);
            //
            // [ VT_UNKNOWN ] : Returns an IPortableDevicePropVariantCollection (of VT_UI4) of event params for a vendor-extended event
            WPD_PROPERTY_MTP_EXT_EVENT_PARAMS.fmtid = new Guid(0x4d545058, 0xef88, 0x4e4d, 0x95, 0xc3, 0x4f, 0x32, 0x7f, 0x72, 0x8a, 0x96);
            WPD_PROPERTY_MTP_EXT_EVENT_PARAMS.pid = 1011;
        }
        
        internal static readonly Guid WPD_CATEGORY_MTP_EXT_VENDOR_OPERATIONS;
        internal static readonly Guid WPD_PROPERTIES_MTP_VENDOR_EXTENDED_OBJECT_PROPS;
        internal static readonly Guid WPD_PROPERTIES_MTP_VENDOR_EXTENDED_DEVICE_PROPS;
        internal static readonly Guid WPD_EVENT_MTP_VENDOR_EXTENDED_EVENTS;

        internal static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_MTP_EXT_GET_SUPPORTED_VENDOR_OPCODES;
        internal static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_MTP_EXT_EXECUTE_COMMAND_WITHOUT_DATA_PHASE;
        internal static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_MTP_EXT_EXECUTE_COMMAND_WITH_DATA_TO_READ;
        internal static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_MTP_EXT_EXECUTE_COMMAND_WITH_DATA_TO_WRITE;
        internal static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_MTP_EXT_READ_DATA;
        internal static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_MTP_EXT_WRITE_DATA;
        internal static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_MTP_EXT_END_DATA_TRANSFER;
        internal static PortableDeviceApiLib._tagpropertykey WPD_COMMAND_MTP_EXT_GET_VENDOR_EXTENSION_DESCRIPTION;

        // Command Parameters 
        // [ VT_UI4 ] : Input param which identifies the vendor-extended MTP operation code
        internal static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_MTP_EXT_OPERATION_CODE;
        // [ VT_UNKNOWN ] : Input IPortableDevicePropVariantCollection (of VT_UI4) specifying the params for the vendor operation
        internal static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_MTP_EXT_OPERATION_PARAMS;
        // [ VT_UI4 ] : Output param which identifies the response code for the vendor operation;
        internal static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_MTP_EXT_RESPONSE_CODE;
        // [ VT_UNKNOWN ] : Returns an IPortableDevicePropVariantCollection (of VT_UI4) of response params for the vendor operation;
        internal static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_MTP_EXT_RESPONSE_PARAMS;
        // [ VT_UNKNOWN ] : Returns an IPortableDevicePropVariantCollection (of VT_UI4) of Vendor-extended MTP codes ;
        internal static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_MTP_EXT_VENDOR_OPERATION_CODES;
        // [ VT_LPWSTR ] : Returned as a context idetifier (a string value) for subsequent data transfer ;
        internal static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_MTP_EXT_TRANSFER_CONTEXT;
        // [ VT_UI8 ] : Input (when writing data) or output (when reading data) param which specifies total data size in bytes (excluding any overhead);
        internal static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_MTP_EXT_TRANSFER_TOTAL_DATA_SIZE;
        // [ VT_UI4 ] : Input param specifying the number of bytes to read from device in a series of read calls ;
        internal static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_MTP_EXT_TRANSFER_NUM_BYTES_TO_READ;
        // [ VT_UI4 ] : Output param specifying the actual number of bytes (no overhead) received from device in a read call ;
        internal static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_MTP_EXT_TRANSFER_NUM_BYTES_READ;
        // [ VT_UI4 ] : Input specifying the number of bytes to send to device in a series of write calls;
        internal static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_MTP_EXT_TRANSFER_NUM_BYTES_TO_WRITE;
        // [ VT_UI4 ] : Returns the actual number of bytes (no overhead) sent to device in a write call ;
        internal static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_MTP_EXT_TRANSFER_NUM_BYTES_WRITTEN;
        // [ VT_VECTOR|VT_UI1 ] : Stores the binary data to transfer from/to device;
        internal static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_MTP_EXT_TRANSFER_DATA;
        // [ VT_UI4 ] : Returns the optimal size of the transfer buffer;
        internal static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_MTP_EXT_OPTIMAL_TRANSFER_BUFFER_SIZE;
        // [ VT_LPWSTR ] : Returns vendor extension description string;
        internal static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_MTP_EXT_VENDOR_EXTENSION_DESCRIPTION;
        // [ VT_UNKNOWN ] : Returns an IPortableDevicePropVariantCollection (of VT_UI4) of event params for a vendor-extended event;
        internal static PortableDeviceApiLib._tagpropertykey WPD_PROPERTY_MTP_EXT_EVENT_PARAMS;

        // from MtpExt.h
        internal const uint MTP_RESPONSE_OK = 0x2001;
