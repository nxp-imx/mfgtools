...
Return Value:
    ...
    The device extension maintains the pipe context for 
    the pipe on STMP3410/3500/3600 device.
...
--*/
{
	...
	BulkUsb_DbgPrint(3, ("BulkUsb_DispatchReadWrite - begins fo:%p ctx:%p\n", fileObject, fileObject->FsContext));
