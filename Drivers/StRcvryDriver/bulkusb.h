...
// Active units to support multiple adapters
#define MAX_INSTANCES 100
#define INSTANCE_FREE 0
#define INSTANCE_USED 1
#define NO_INSTANCE_AVAILABLE 0xFFFFFFFF

typedef struct _GLOBALS {
    UNICODE_STRING BulkUsb_RegistryPath;
	ULONG Stmp3RecInstances[MAX_INSTANCES]; 
} GLOBALS;
...
#define BULKUSB_MAX_TRANSFER_SIZE   4096 /*256*/
...
#define BULKUSB_REGISTRY_PARAMETERS_PATH  \
    L"\\REGISTRY\\Machine\\System\\CurrentControlSet\\SERVICES\\StMp3Recx64\\Parameters"
...
typedef struct _DEVICE_EXTENSION {
    ...
    // unit instance; appended to device name
    ULONG Instance;
    ...
    // Name buffer for our named Functional device object link
    // The name is generated based on the driver's name StMp3RecDevice
    UNICODE_STRING DeviceName;

    // Name buffer for our named Functional device object link
    // \DosDevices\StMp3RecDevice?
