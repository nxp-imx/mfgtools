...
class WindowsVersionInfo
{
	...
	int IsWin9x() { return ( m_family == WIN_9X ); };
	int IsWinNT() { return ( m_family == WIN_NT ); };
	...
	WindowsVersionInfo()
	{
        ...
        CStdString keyName = _T("Software\\Microsoft\\MediaPlayer\\Setup\\Installed Versions");
...
extern WindowsVersionInfo& gWinVersionInfo();
