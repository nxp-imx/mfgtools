...
//	void TrimWhiteSpace(CString &_csStr);
...
private:
	void InitFonts();
	UINT HowManyLines(CString _csStr);
	void WriteLines(CString _csStr, UINT& _pos, CPaintDC * _pDC, int& _iX, int& _iY, int _iCX, int _iCY);
