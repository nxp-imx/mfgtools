...
/**///clw
	...
	m_p_config_mgr = new CConfigMgrSheet(_T("MfgTool - Configuration"), pFrame);
	...
	if (!ValidateHardwareId())
	{
		...
		::MessageBox(NULL, resStr, _T("MfgTool"), MB_OK);
		return FALSE;
	}
#endif
...
void CStMfgToolApp::OnAppAbout()
{
	...
	else
	{
		...
		copyright_text = _T("Copyright (c) 2009, Freescale Semiconductor, Inc.\nAll Rights Reserved");
	}
