...
#define CFG_SYSTEM_DRIVE_PADDING_PERCENTAGE 0
...
#define DEF_CFG_REBOOT_MSG		TRUE
...
#define DEF_CFG_DRVARRAY_NUM_DRIVES		11
#define DEF_CFG_DRVARRAY_ONE			L",Data Drive,0,0x0A,0\0"
#define DEF_CFG_DRVARRAY_TWO			L",Janus Drive,2,0x0B,0\0"
#define DEF_CFG_DRVARRAY_THREE			L"bootmanager.sb,Boot Manager,1,0x50,0\0"
#define DEF_CFG_DRVARRAY_FOUR			L"hostlink.sb,Host Link,1,0x01,0\0"
#define DEF_CFG_DRVARRAY_FIVE			L"stmpsys.sb,Player,1,0x00,0\0"
#define DEF_CFG_DRVARRAY_SIX			L"resource.bin,Player Resource,1,0x02,0\0"
#define DEF_CFG_DRVARRAY_SEVEN			L"resource.bin,Player Resource 2,1,0x12,0\0"
#define DEF_CFG_DRVARRAY_EIGHT			L"resource.bin,Player Resource 3,1,0x22,0\0"
#define DEF_CFG_DRVARRAY_NINE			L"hostrsc.bin,Host Resource,1,0x06,0\0"
#define DEF_CFG_DRVARRAY_TEN			L"hostrsc.bin,Host Resource 2,1,0x16,0\0"
#define DEF_CFG_DRVARRAY_ELEVEN			L"hostrsc.bin,Host Resource 3,1,0x26,0\0"
#define DEF_CFG_DRVARRAY_TWELVE			L"\0"
#define DEF_CFG_DRVARRAY_THIRTEEN		L"\0"
#define DEF_CFG_DRVARRAY_FOURTEEN		L"\0"
#define DEF_CFG_DRVARRAY_FIFTEEN		L"\0"
